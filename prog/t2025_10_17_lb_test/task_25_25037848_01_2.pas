...
begin
  ...
  var n : BigInteger = 1_000_000;
  while n in 1_000_000..10_000_000_000 do begin 
      if Regex.IsMatch(n.ToString,'^32\d056(?:\d)*6$') and (n mod dv = 0) then nums.Add((n,n div dv)); end;
